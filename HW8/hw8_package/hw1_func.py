...
def folders_info(path: str) -> None:
    result = []
    ...
    with (open('folder_info.json', 'w', encoding='utf-8') as f_json,
          open('folder_info.csv', 'w', encoding='utf-8') as f_csv,
          open('folder_info.pickle', 'wb') as file_pickle
          ):
